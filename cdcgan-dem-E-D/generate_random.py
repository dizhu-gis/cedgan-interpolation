...
parser.add_argument('--outf', default='outfile_generate_loss_rdsampled', help='folder to output images and model checkpoints')
parser.add_argument('--manualSeed', type=int, help='manual seed')
parser.add_argument('--dataset', default='DEM', help='which dataset to train on, DEM')
parser.add_argument('--netG', default='', help="path to netG (to continue training)")
parser.add_argument('--logfile', default='outfile_generate/errlog.txt', help="logfile to record error")
parser.add_argument('--epoch', type=int,default=10, help="netG state1")
...
def KrigeDems(dems,ncp):
    ...
    for n in range(0,opt.batchSize):
        ...
        for i in x_index:
            for j in y_index:
                cpDems[n].append([j,i,dems.data[n,0,j,i]])# extract dem control point function
...
krigeDems=KrigeDems_random(mdems,ncp)
